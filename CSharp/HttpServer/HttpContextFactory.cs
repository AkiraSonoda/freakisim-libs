...
namespace HttpServer
{
    ...
    public class HttpContextFactory : IHttpContextFactory
    {
        ...
        /// </returns>
        public HttpClientContext CreateContext(Socket socket)
        {
			var networkStream = new ReusableSocketNetworkStream(socket, true);
            var remoteEndPoint = (IPEndPoint) socket.RemoteEndPoint;
    ...
    public interface IHttpContextFactory
    {
        ...
        HttpClientContext CreateContext(Socket socket);
        ...
        HttpClientContext CreateSecureContext(Socket socket, X509Certificate certificate, SslProtocols protocol);
