...
namespace HttpServer.HttpModules
{
    ...
    public abstract class HttpModule
    {
        ...
        public abstract bool Process(HttpRequest request, HttpResponse response, IHttpSession session);
        /*
        /// <summary>
        ...
        public abstract bool IsAuthenticationRequired(IHttpRequest request, HttpResponse response, IHttpSession session,
                                                      HttpCookies cookies);
         * */
